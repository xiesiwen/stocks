...
maotai = pd.read_csv('D:/stocks/sz.002027.csv')  # 读取股票文件

training_set = maotai.iloc[1000:3426 - 300, 1:2].values  # 前(2426-300=2126)天的开盘价作为训练集,表格从0开始计数，2:3 是提取[2:3)列，前闭后开,故提取出C列开盘价
test_set = maotai.iloc[3426 - 300:3426-270, 1:2].values  # 后300天的开盘价作为测试集
...
real_stock_price = sc.inverse_transform(test_set[20:])
# 画出真实数据和预测数据的对比曲线
